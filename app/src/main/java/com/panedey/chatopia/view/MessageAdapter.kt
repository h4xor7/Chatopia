...
class MessageAdapter(private val mMessageList: List<Messages>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MessageViewHolder {
        ...
        val itemAddressBinding =
            MessageSingleLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class MessageViewHolder(val messageSingleLayoutBinding: MessageSingleLayoutBinding) :
